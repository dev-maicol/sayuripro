...
@section('content')
    <div class="p-6 max-w-lg mx-auto">
        <h2 class="text-lg font-semibold text-gray-700 dark:text-white mb-4">Crear unidad de medida</h2>

        <form x-data="{ loading: false }" @submit="loading = true" action="{{ route('unidades_medida.store') }}" method="POST"
