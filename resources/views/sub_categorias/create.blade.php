...
@section('content')
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow max-w-xl mx-auto">
        <h2 class="text-xl font-bold mb-4 text-white">Crear Subcategoría</h2>
        ...
        <form method="POST" action="{{ route('sub_categorias.store') }}" x-data="{ loading: false }" @submit.prevent="loading = true; $el.submit()">
            @csrf
